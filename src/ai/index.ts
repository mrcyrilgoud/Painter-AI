...
import { mockSegmenter } from "./mockSegmenter";
import { mockCopilot } from "./mockCopilot";
import { codexBackend } from "./codex/codexBackend";
import { codexSegmenter } from "./codex/codexSegmenter";
...
const segmenterKind = (import.meta.env.VITE_AI_SEGMENTER as string | undefined) ?? "mock";
...
export const segmenter: Segmenter = segmenterKind === "codex" ? codexSegmenter : mockSegmenter;
